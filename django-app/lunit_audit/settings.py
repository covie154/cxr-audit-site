...
Django settings for lunit_audit project.
...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-#anwc-n(f(rm--f*_fzae9n8v01%dh$z=u@#f&74935znj7^@*"
)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "upload.context_processors.admin_status",
            ],
        },
    },
]

WSGI_APPLICATION = "lunit_audit.wsgi.application"
...
# Collected static files destination (used by collectstatic + WhiteNoise)
...
CXR_API_CONFIG = {
    "API_IP": os.environ.get("CXR_API_IP", "localhost"),
...
# Email configuration
# Set these environment variables for production SMTP:
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "PRIMER-LLM <noreply@primer-llm.local>")

# Logging — ensure errors appear in Gunicorn / Docker logs
LOGGING = {
    "version": 1,
